...
const AkadResepsi = () => {
  ...
  const count = useCountUp(9, 4, isIntersecting ? 'inView' : 'outOfView');
    ...
    <div ref={ref} className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-12 overflow-hidden">
      <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: 'easeInOut' }} viewport={{ once: false, amount: 0.5 }} className="text-center mb-12">
        <h1 className="text-xl font-bold mb-2 space-y-0">
          Syukuran <br /> <span className="text-4xl font-bold">Pernikahan</span>
        </h1>
      ...
      >
        ...
        >
          ...
          <h2 className="text-2xl font-bold mb-2">Syukuran</h2>
          ...
          <p className="text-gray-600 mb-4">08.00 WIB - Selesai</p>
          <Separator className="max-w-[5rem] mb-4" />
          <div>
            <MapPin size={25} />
          </div>
          <p className="text-gray-600 font-bold mb-4">Rumah mempelai laki-laki</p>
          <p className="text-gray-600 mb-4">
            Jl. Cilandak No.30, Sarijadi,<br /> Kec. Sukasari, Kota Bandung, <br />Jawa Barat 40151
            
             
          </p>
          <Button asChild className="bg-gray-800 text-white py-2 px-4 rounded-lg">
            <Link href="https://maps.app.goo.gl/t2nMRP59yr2cikWdA" target="_blank">
